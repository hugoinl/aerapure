...
const PRICES = {
  ...
  label: "Berline",
  tabs: [
    { id: "complet", label: "Intérieur + extérieur", items: [{ name: "Berline — Complet", price: "100€ TTC" }] },
    { id: "interieur", label: "Intérieur", items: [{ name: "Berline — Intérieur", price: "80€ TTC" }] },
    { id: "exterieur", label: "Extérieur", items: [{ name: "Berline — Extérieur", price: "30€ TTC" }] }
  ]
},
  suv: {
    label: "SUV / Monospace / Break",
    tabs: [
      { id: "complet", label: "Intérieur + extérieur", items: [{ name: "SUV / Monospace / Break — Complet", price: "120€ TTC" }] },
      { id: "interieur", label: "Intérieur", items: [{ name: "SUV / Monospace / Break — Intérieur", price: "90€ TTC" }] },
      { id: "exterieur", label: "Extérieur", items: [{ name: "SUV / Monospace / Break — Extérieur", price: "30€ TTC" }] }
    ]
  },
  utilitaire: {
    label: "Utilitaire",
...
(function(){
  ...
  const map = {
    ...
    "Berline": [
      { id:"complet", label:"Intérieur + extérieur", price:"100€ TTC" },
      { id:"interieur", label:"Intérieur", price:"80€ TTC" },
