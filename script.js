...
const PRICES = {
  "citadine": {
    ...
    tabs: [
      { id: "complet", label: "Intérieur + extérieur", items: [{ name: "Citadine / Berline — Complet", price: "80€ TTC" }] },
      { id: "interieur", label: "Intérieur", items: [{ name: "Citadine / Berline — Intérieur", price: "60€ TTC" }] },
      { id: "exterieur", label: "Extérieur", items: [{ name: "Citadine / Berline — Extérieur", price: "20€ TTC" }] }
    ]
  },
  "suv": {
